/*! angular-lookup-directive 17-11-2015 */

!function () {
    "use strict";
    var a = ["$http", "$q"], b = function (a, b) {
        var c = '<div><input type="text" ng-model="value" class="ruaghain-lookup" ng-keypress="onKeyPress($event)" ng-blur="onBlur($event)"><ul><li ng-repeat="record in foundRecords"><a href="#" ng-click="onItemSelect(record)">{{record[lookupTextField]}}</a></li></ul></div><div ng-show="addRecord"><button id="btnSave" ng-click="saveLookup()">Save</button><button id="btnCancel" ng-click="cancel()">Cancel</button></div>', d = function (c, d, e, f) {
            var g = d.find("input");
            f.$formatters.push(function (a) {
                ...
                g.val(a[c.lookupTextField]), f.$setViewValue(a), c.clearResults()
            }, c.onKeyPress = function (a) {
                var b = a.which;
                27 === b ? c.clearResults() : (b > 64 && 91 > b || b > 96 && 123 > b || 40 === b) && c.search()
            }, c.onBlur = function (a) {
            }, c.clearResults = function () {
                c.foundRecords = [], c.addRecord = !1
            }, c.search = function () {
                c.findRestData(g).then(function (a) {
                    c.addRecord = c.lookupDatasource().allowInsert && "undefined" == typeof a, c.foundRecords = a
                })
