/*! angular-lookup-directive 21-07-2015 */

!function () {
    "use strict";
    var a = function () {
        var a = '<div><input type="text" class="ruaghain-lookup" ng-keyup="search()"><ul><li ng-repeat="record in foundRecords"><a href="#" ng-click="onItemSelect(record)">{{record[lookupTextField]}}</a></li></ul></div>', b = function (a, b, c, d) {
            var e = b.find("input");
